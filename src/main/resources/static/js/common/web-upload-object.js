...
(function() {
	...
	var $WebUpload = function(pictureId, uploadUrl) {
		...
		bindEvent : function(bindedObj) {
			...
			bindedObj.on('uploadProgress', function(file, percentage) {
                layer.open({
                    ...
                    scrollbar: false,
                    area: ['700px', '65px'],
                    content: '<div class="progress progress-striped" style="margin-top: 2px;margin-left:2px;margin-right:4px;">\n' +
                    '              <div id="progressBar" style="width: 0%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="0" role="progressbar" class="progress-bar progress-bar-info"></div>\n' +
                    '         </div>'
                });
