...
import com.fit.modular.system.dao.DictMapper;
...
import static com.fit.core.common.constant.factory.MutiStrFactory.*;
...
//                itemDict.setNum(1);
                ...
                throw new BizException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
    ...
    @Override
    public List<ZTreeNode> tree(String name) {
        return this.baseMapper.tree(name);
    }
}
