...
import com.fit.core.common.constant.dictmap.MenuDict;
import com.fit.core.common.constant.factory.ConstantFactory;
import com.fit.core.common.constant.state.MenuStatus;
...
import com.fit.core.support.BeanKit;
import com.fit.core.util.ToolUtil;
import com.fit.modular.system.model.Menu;
import com.fit.modular.system.service.IMenuService;
import com.fit.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new BizException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new BizException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
