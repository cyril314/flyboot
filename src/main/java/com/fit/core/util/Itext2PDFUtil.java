...
public class Itext2PDFUtil {
    ...
    public static String createPDF() throws Exception {
        ...
        PdfPCell cell = new PdfPCell(new Phrase("企业名称", boldFont));
        ...
        Chunk c90 = new Chunk("信息主体于2022年**月**日提出异议：我公司从未发生过***；业务发生机构于2022年**月**日提交说明：该笔信息确实存在；信息主体于2022年**月**日提出声明：该笔信息为我公司***所致。（在每一板块下详细记录信息主体提出异议处理过程和结果。）", redTextFont);
        ph1.add(c89);
        ph1.add(c90);
        p1.add(ph1);
        doc.add(p1);
