package com.fit.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "fit.flowable.muti-datasource")
public class MutiDataSourceProperties {

    private String defaultDataSourceName = "dataSourceFit";
