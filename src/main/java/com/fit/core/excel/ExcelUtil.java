...
public class ExcelUtil {
     ...
     * @param isx         是否excel2007
     */
    private ExcelTemplate handlerObj2Excel(String template, List objs, Class clz, boolean isClasspath, boolean isx, boolean hasBeeCode) {
        ExcelTemplate et = ExcelTemplate.getInstance();
        try {
            if (isClasspath) {
                if (hasBeeCode) {
//                    et.readTemplateByClasspath(template, isx, objs);
                    et.readTemplateByClasspath(template, isx);
                } else {
                    et.readTemplateByClasspath(template, isx);
                }
            } else {
            ...
            for (Object obj : objs) {
                ...
                for (ExcelHeader eh : headers) {
                    ...
                    if(hasBeeCode){
                        et.createCell(BeanUtils.getProperty(obj, getMethodName(eh)), true);
                    } else {
     ...
     * @param isx         是否是2007版本
     */
    public void exportObj2ExcelByTemplate(Map<String, String> datas, String template, OutputStream os, List objs, Class clz, boolean isClasspath, boolean isx, boolean hasBeeCode) {
        try {
            ExcelTemplate et = handlerObj2Excel(template, objs, clz, isClasspath, isx, hasBeeCode);
     ...
     * @param isClasspath 模板是否在classPath路径下
     */
    public void exportObj2ExcelByTemplate(Map<String, String> datas, String template, String outPath, List objs, Class clz, boolean isClasspath, boolean isx, boolean hasBeeCode) {
        ExcelTemplate et = handlerObj2Excel(template, objs, clz, isClasspath, isx, hasBeeCode);
        et.replaceFinalData(datas);
     ...
     * @param isClasspath 模板是否在classPath路径下
     */
    public void exportObj2ExcelByTemplate(Properties prop, String template, OutputStream os, List objs, Class clz, boolean isClasspath, boolean isx, boolean hasBeeCode) {
        ExcelTemplate et = handlerObj2Excel(template, objs, clz, isClasspath, isx, hasBeeCode);
     ...
     * @param isClasspath 模板是否在classPath路径下
     */
    public void exportObj2ExcelByTemplate(Properties prop, String template, String outPath, List objs, Class clz, boolean isClasspath, boolean isx, boolean hasBeeCode) {
        ExcelTemplate et = handlerObj2Excel(template, objs, clz, isClasspath, isx, hasBeeCode);
        et.replaceFinalData(prop);
        et.writeToFile(outPath);
    }
