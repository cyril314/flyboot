 ...
 */
public class FitDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public FitDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public FitDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
