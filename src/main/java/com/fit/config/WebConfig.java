...
import com.fit.core.listener.ConfigListener;
import com.fit.core.xss.XssFilter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        if (fitProperties.getSwaggerOpen()) {
    ...
    public FilterRegistrationBean druidStatFilter() {
        ...
        //添加不需要忽略的格式信息.
        druidFilter.addInitParameter("exclusions", "/static/*,*.js,*.gif,*.jpg,*.png,*.css,*.ico,/druid,/druid/*");
        //用于session监控页面的用户名显示 需要登录后主动将username注入到session里
        druidFilter.addInitParameter("principalSessionName", "username");
        return druidFilter;
    }
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.fit.modular.*.service.*";
        //可以set多个
