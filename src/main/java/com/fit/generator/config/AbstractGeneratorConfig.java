...
import com.fit.generator.base.TemplateEngine;
 ...
 */
public abstract class AbstractGeneratorConfig extends TemplateEngine {
    ...
    public void doGeneration() {
        super.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        super.setSqlConfig(sqlConfig);
