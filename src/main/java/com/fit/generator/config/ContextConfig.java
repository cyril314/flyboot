...
public class ContextConfig {
    ...
    private String templatePrefixPath = "masterplate";
    private String projectPath = System.getProperty("user.dir");//模板输出的项目目录
    ...
    private String proPackage = "com.fit.admin";
    private String coreBasePackage = "com.fit.core";
    private String modelPackageName = "com.fit.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.fit.modular.system.dao";    //model的dao
